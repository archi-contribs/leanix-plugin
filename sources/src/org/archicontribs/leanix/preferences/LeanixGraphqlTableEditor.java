...
public class LeanixGraphqlTableEditor extends FieldEditor {
	 ...
	 * @param parent 
	 */
	public LeanixGraphqlTableEditor(String name, String labelText, Composite parent) {
		init(name, labelText);
	...
	protected void doFillIntoGrid(Composite parent, int numColumns) {
		...
		this.tblGraphql.addControlListener(new ControlAdapter() {
			...
			@Override public void controlResized(ControlEvent event) {
				LeanixGraphqlTableEditor.this.tblGraphql.getColumns()[0].setWidth(LeanixGraphqlTableEditor.this.tblGraphql.getClientArea().width);
			}
		});
	...
	void newCallback(Composite parent) {
		...
		LeanixGraphql newLeanixGraphql = editGraphql(parent, null);
		if ( newLeanixGraphql != null ) {
			/* todo */
		}
	}
