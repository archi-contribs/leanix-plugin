 ...
 */
public class LeanixTextFieldEditor extends FieldEditor {
	 ...
	 */
	protected LeanixTextFieldEditor() {
	}
	/**
	 ...
	 * @since 2.0
	 */
	public LeanixTextFieldEditor(String name, String labelText, int width, int strategy, Composite parent) {
		init(name, labelText);
	 ...
	 * @param parent the parent of the field editor's control
	 */
	public LeanixTextFieldEditor(String name, String labelText, int width, Composite parent) {
	 ...
	 * @param parent the parent of the field editor's control
	 */
	public LeanixTextFieldEditor(String name, String labelText, Composite parent) {
	...
	protected void doLoad() {
		if (this.textField != null) {
			String value = LeanixPlugin.INSTANCE.getPreferenceStore().getString(getPreferenceName());
	...
	protected void doLoadDefault() {
		if (this.textField != null) {
			String value =
					LeanixPlugin.INSTANCE.getPreferenceStore().getDefaultString(getPreferenceName());
			this.textField.setText(value);
		}
		valueChanged();
	}
	...
	protected void doStore() {
		LeanixPlugin.INSTANCE.getPreferenceStore().setValue(getPreferenceName(), this.textField.getText());
	}
	...
	public String getStringValue() {
		...
		return LeanixPlugin.INSTANCE.getPreferenceStore().getString(getPreferenceName());
	}
		...
		if (this.textField == null) {
			...
			this.textField.addDisposeListener(new DisposeListener() {
				...
				public void widgetDisposed(DisposeEvent event) {
					LeanixTextFieldEditor.this.textField = null;
				}
			});
	...
	*/
	...
	public void setStringValue(String value) {
		if (this.textField != null) {
			...
			if (!LeanixPlugin.areEqual(this.oldValue, newValue)) {
	...
	protected void valueChanged() {
		...
		if (!LeanixPlugin.areEqual(newValue, this.oldValue)) {
